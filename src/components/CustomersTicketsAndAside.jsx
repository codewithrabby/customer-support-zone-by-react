  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-4">
      ...
      <div className="lg:w-3/4 w-full">
        <h2 className="text-[#34485A] font-semibold text-2xl mb-4 ml-4 lg:ml-0">
          Customer Tickets
        </h2>
          ...
          {customersData.map((customer) => {
            ...
            return (
              ...
              >
                ...
                {/* Info Section (id/priority + name/date) */}
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                  ...
                  <div className="flex items-center gap-2 text-[#627382]">
                    <p className="mr-2">{customer.customerName}</p>
                    <span className="flex items-center gap-1">
                      <img src={calenderImg} alt="Calendar" className="w-4 h-4" /> 
                      {customer.date}
                    </span>
                  </div>
                </div>
